...
parser.add_argument(
    "--category", type=str, default="pill", help="Category of the dataset"
)
parser.add_argument(
    "--backbone", type=str, default="mobilenet_v2", help="Pre trained CNN backbone"
)
parser.add_argument(
    "--file_pos",
    type=int,
    default=0,
    help="Position of the memory bank in the memory bank folder",
)
parser.add_argument(
    "--decomposition",
    type=str,
...
parser.add_argument(
    "--n_components", type=int, default=2, help="Number of components for PCA and UMAP"
)
parser.add_argument(
    "--n_neighbors", type=int, default=15, help="Number of neighbors for UMAP"
)
parser.add_argument(
    "--min_dist", type=float, default=0.1, help="Minimum distance for UMAP"
)
...
if args.decomposition == "pca":
    ...
    raise ValueError(
        f"Decomposition method {args.decomposition} not supported. Supported decomposition methods: ['pca','umap']"
    )
...
plot_path_dirpath = generate_path(
    basepath=patchif_results_path, folders=["memory_bank_plots", args.decomposition]
)
